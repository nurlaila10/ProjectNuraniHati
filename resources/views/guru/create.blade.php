...
<div class="white_card card_height_100 mb_30">
    ...
    <div class="white_card_body">
        <form method="post" action="/guru/store" autocomplete="off">
            @csrf
            <div class="mb-3">
                <label class="form-label" for="exampleInputEmail1">Nama Guru</label>
                <input type="text" name="nama_guru" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Nama">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="pendidikan" class="form-control" id="exampleInputPassword1" placeholder="Masukan Pendidkan">
            </div>
            <div class="mb-3">
